...
const grandmaMessages = ["GOOD JOB SON!", "IM IMPRESSED!", "NICE ONE!", "WAY TO GO!"]
...
function showGrandma() {
    ...
    setTimeout(function(){ grandma.style.display = "none"; }, 1000); //grandma will leave for groceries after congratulating player ;)
}
